module.exports = function (grunt) {
  ...
  grunt.registerTask('compile-weking-newer', ['less:main', 'watch:main']);

  // Compile theme
  grunt.registerTask('compile-theme', ['less:theme']);
  grunt.registerTask('compile-theme-newer', ['less:theme', 'watch:theme']);

  // Compile full
  grunt.registerTask('compile', ['compile-weking', 'compile-theme']);
  grunt.registerTask('compile-newer', ['less:main', 'less:theme', 'watch:full']);
